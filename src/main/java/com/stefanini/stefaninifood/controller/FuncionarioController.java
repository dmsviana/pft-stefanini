...
import com.stefanini.stefaninifood.bean.FuncionarioFacade;
...
public class FuncionarioController implements Serializable {
    ...
    @EJB
    private com.stefanini.stefaninifood.bean.FuncionarioFacade ejbFacade;
    ...
    public void create() {
        ...
        if(funcionarioJaExiste(this.selected)){
            JsfUtil.addErrorMessage("O funcionário já existe!");
        } else {
             persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("FuncionarioCreated"));
        }
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("FuncionarioUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("FuncionarioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public boolean funcionarioJaExiste(Funcionario funcionario){
        ...
        List<Funcionario> list = getItems();
        return list.stream().anyMatch((item) -> (item.getCPF().equals(cpf)));
